...
module.exports = {
    ethFaucet : {
        post : async (req, res) => {
            ...
            try {
                const ganache = await models.Users.findOne({where: {userName: 'ganache'}});
                models.Users.findOne({where: {userName: name}}).then((data)=> {
                    ...
                    getWeb3().eth.accounts.signTransaction({
                        to: address,
                        value: '1000000000',
                        gas: 2000000
                    }, ganache.privateKey)
                    .then((data) => {
                        ...
                        getWeb3().eth.getBalance(address).then(bal => {
                            res.json({message: "Faucet Successed",
                            data: {
                                userName: userName,
                                address: address,
                                balance: bal,
        ...
        get : async (req, res) => {
            ...
            models.Users.findOrCreate({
                ...
                defaults: {
                    ...
                    address: accounts[0],
                    privateKey: 'df6724dcf00c43fa0e000a01792fc830e77a7f77483376f98fbcd00203890988'
                }
